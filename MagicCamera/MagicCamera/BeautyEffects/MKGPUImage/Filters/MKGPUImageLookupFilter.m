...
NSString *const kMKGPUImageLookupVertexShaderString = SHADER_STRING
(
...
NSString *const kMKGPUImageLookupFragmentShaderString = SHADER_STRING
(
...
@interface MKGPUImageLookupFilter(){
...
@implementation MKGPUImageLookupFilter

- (id)initWithContext:(MKGPUImageContext *)context{
    if (!(self = [super initWithContext:context vertexShaderFromString:kMKGPUImageLookupVertexShaderString fragmentShaderFromString:kMKGPUImageLookupFragmentShaderString])) {
        return nil;
    }
    ...
    self.intensity = 0.0f;
    self.lookup = [UIImage imageNamed:@"lookup_new.png"];
