...
#import "MKGPUImageBeautifyFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kMKGPUImageBeautyFragmentShaderString = SHADER_STRING
(
...
@implementation MKGPUImageBeautifyFilter
...
- (id)initWithContext:(MKGPUImageContext *)context vertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString {
    ...
    if (!(self = [super initWithContext:context vertexShaderFromString:vertexShaderString fragmentShaderFromString:kMKGPUImageBeautyFragmentShaderString])) {
        return nil;
    }
...
- (void)setInputSize:(CGSize)newSize;
{
    ...
    [filterProgram use];
    glUniform2fv([filterProgram uniformIndex:@"singleStepOffset"], 1, positionArray);
...
- (void)setBrightLevel:(CGFloat)brightLevel {
    ...
    [self.context useAsCurrentContext];
    [filterProgram use];
    glUniform1f([filterProgram uniformIndex:@"brightness"], 0.6 * (-0.5 + brightLevel));
}

- (void)setParams:(CGFloat)beauty tone:(CGFloat)tone {
    MKGPUVector4 fBeautyParam;
    ...
    [self.context useAsCurrentContext];
    [filterProgram use];
    glUniform4fv([filterProgram uniformIndex:@"params"], 1, (GLfloat *)&fBeautyParam);
}
