...
@interface MKShortEffectHandler()
{
...
@property (nonatomic, strong) MKGPUImageBeautifyFilter  *beautifyFilter;
...
@implementation MKShortEffectHandler
...
- (instancetype)initWithProcessTexture:(Boolean)isProcessTexture;
{
    ...
    if (self) {
        ...
        runMSynchronouslyOnContextQueue(_glContext, ^{
            ...
            _beautifyFilter = [[MKGPUImageBeautifyFilter alloc] initWithContext:_glContext];
